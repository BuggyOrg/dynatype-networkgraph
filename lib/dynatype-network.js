...
exports.addTypeConversion = addTypeConversion;
...
function addTypeConversion(processGraph, convertGraph) {
  ...
  try {
    for (var _iterator = processGraph.edges()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
